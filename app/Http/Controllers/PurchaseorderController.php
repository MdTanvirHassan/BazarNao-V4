...
class PurchaseorderController extends Controller
{
    ...
    public function index()
    {
        ...
        $temp_data = DB::table('purchase_order as po')
        ...
        return view('backend.purchase_order.index', compact('data', 'title'));
    }
    ...
    public function create()
    {
        ...
        return View::make('contents.purchase_order.add')
    ...
    public function store()
    {
        ...
        $bill_id = DB::table('purchase_order')->insertGetId(
            array(
        ...
        for ($i = 0; $i < count(Input::get('qty')); $i++) {
            ...
            DB::table('purchase_order_item')->insertGetId(
                array(
                    'po_id' => $bill_id,
                    'code' => $code,
    ...
    public function edit($id)
    {
        ...
        $data_row = DB::table('purchase_order as po')
        ...
        $bill_id = $data_row[0]->po_id;
        $data_item_rows = DB::table('purchase_order_item as bi')
            ->join('products as op', 'op.id', '=', 'bi.code')
            ->where('bi.status', '=', 1)
            ->where('bi.po_id', '=', $bill_id)
            ->get(['bi.*', 'op.name']);
        ...
        return View('backend.purchase_order.edit',compact('temp_data', 'data_temp', 'data_row', 'data_item_rows', 'title'));
    }
    ...
    public function show($id)
    {
        ...
        $data_item_rows = DB::table('purchase_order_item as poi')
        ...
        return View::make('contents.purchase_order.view')
