    ...
    AIZ.uploader = {
                            ...
                            $.ajax({
                                ...
                                success: function () {
                                    ...
                                    AIZ.uploader.getAllUploads(
                                        AIZ.data.appUrl +
                                            "/invoice-uploader/get_uploaded_files"
                                    );
        ...
        inputSelectPreviewGenerate: function (elem) {
            ...
            if (AIZ.uploader.data.selectedFiles.length > 0) {
                ...
                $.post(
                    AIZ.data.appUrl + "/invoice-uploader/get_file_by_ids",
        ...
        trigger: function (
            ...
            // setTimeout(function() {
            $.post(
                AIZ.data.appUrl + "/invoice-uploader",
                { _token: AIZ.data.csrf },
                function (data) {
                    $("body").append(data);
                    $("#aizUploaderModal").modal("show");
                    AIZ.plugins.invoiceUppy();
                    AIZ.uploader.getAllUploads(
                        AIZ.data.appUrl + "/invoice-uploader/get_uploaded_files",
                        null,
                        $('[name="aiz-uploader-sort"]').val()
