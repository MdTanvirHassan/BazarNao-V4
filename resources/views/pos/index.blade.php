        ...
        <div class="modal-content">
            ...
            <form id="shipping_form">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-styled btn-base-1" id="confirm-address" data-dismiss="modal">{{translate('Confirm')}}</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="{{ route('addresses.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden"  placeholder="{{translate('Phone')}}" id="warehouse_id" name="warehouse_id" value="{{$wearhouses[0]->id}}" class="form-control" required>
      ...
      document.getElementById('change').value = change.toFixed(2);
        ...
        function submitOrder(payment_type){
           ...
           if(receive_amount == ''){
            ...
            AIZ.plugins.notify('danger', 'Please Enter Received Amount');
            return false;
           }else{
