            ...
            <form class="form-horizontal" action="{{ route('accounts.insert_coa2') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label" for="coahead">{{ translate('COA Head') }}</label>
                        <div class="col-sm-3">
                            <select name="coa_head" class="form-control" onchange="selectparenthead()" id="coahead">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label" for="Parentcategory">{{ translate('Sub COA Head') }}</label>
                        <div class="col-sm-3">
                            <select name="Parentcategory" class="form-control" id="Parentcategory" onchange="selectsubparenthead()">
                                <option value="">{{ translate('Select Option') }}</option>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label" for="ParentSubcategory">{{ translate('Sub-Sub COA Head') }}</label>
                        <div class="col-sm-3">
                            <select name="ParentSubcategory" class="form-control" id="ParentSubcategory">
                                <option value="">{{ translate('Select Option') }}</option>
