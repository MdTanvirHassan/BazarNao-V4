                    ...
                    <tr>
                        ...
                        <td>
                            @if ($refund->refund_status == 0)
                              <span class="badge badge-inline badge-success">{{translate('Peding')}}</span>
    	...
    	<div class="modal-dialog">
            ...
            <form class="form-horizontal member-block" action="{{route('delivered_refund_request')}}" method="POST">
                ...
                <div class="row">
                          ...
                          <div class="col-md-8">
                              <input class="form-control" name="return_qty" required>
                          </div>
                      </div>
                <div class="row">
                          <div class="col-md-4">
                          ...
                          <div class="col-md-8">
                              <input class="form-control" name="return_amount" required>
                          </div>
                      </div>
                <div class="row">
                          <div class="col-md-4">
