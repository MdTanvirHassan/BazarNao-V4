...
<div class="">
	<div class="">
		<form class="form form-horizontal mar-top" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
			@csrf
			<input type="hidden" name="added_by" value="staff">
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group row">
						<label class="col-md-3 col-from-label">{{translate('Deduct Quentity')}}</label>
						<div class="col-md-8">
				...
				<div class="card-body">
					<div class="d-flex">
						<div class="form-group row w-50">
							<label class="col-md-6 col-form-label">{{translate('App Unit Price')}}</label>
							<div class="col-md-6">
								<input type="checkbox" id="toggle-unit-price">
							</div>
						</div>
						<div class="form-group row w-50" id="unit-price-input" style="display: none;">
							<div class="col-md-10 offset-md-3">
								<input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('App Unit price') }}" name="app_unit_price" class="form-control" required disabled>
							</div>
						</div>
					</div>
					...
					<div class="d-flex">
						<div class="form-group row w-50">
							<label class="col-md-6 col-form-label">{{translate('Web Unit Price')}}</label>
							<div class="col-md-6">
								<input type="checkbox" id="toggle-web-unit-price">
							</div>
						</div>
						<div class="form-group row w-50" id="web-unit-price-input" style="display: none;">
							<div class="col-md-10 offset-md-3">
								<input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Web Unit price') }}" name="unit_price" class="form-control" required disabled>
							</div>
						</div>
					</div>
						...
						<div class="d-flex">
							<div class="form-group row w-50">
								<label class="col-md-6 col-form-label">
									<?php echo $wearhouse->name; ?> Wearhouse POS Price
								</label>
								<div class="col-md-6">
									<input type="checkbox" id="toggle-wearhouse-price-<?php echo $wearhouse->id; ?>" name="toggle_wearhouse_price_<?php echo $wearhouse->id; ?>"> 
								</div>
							</div>
							<div class="form-group row w-50" id="wearhouse-price-input-<?php echo $wearhouse->id; ?>" style="display: none;">
								<div class="col-md-10 offset-md-3">
									<input type="number" lang="en" min="0" value="0" step="0.01" placeholder="Unit price" name="wearhouse_unit_price_<?php echo $wearhouse->id; ?>" class="form-control" required disabled>
								</div>
							</div>
						</div>
					<?php } ?>
...
<script type="text/javascript">
	...
	document.getElementById('toggle-unit-price').addEventListener('change', function() {
		var inputDiv = document.getElementById('unit-price-input');
		var inputField = inputDiv.querySelector('input[name="app_unit_price"]');
		if (this.checked) {
	...
	document.getElementById('toggle-web-unit-price').addEventListener('change', function() {
		var inputDiv = document.getElementById('web-unit-price-input');
		var inputField = inputDiv.querySelector('input[name="unit_price"]');
		if (this.checked) {
			inputDiv.style.display = 'flex';
			inputField.disabled = false;
		} else {
	...
	<?php foreach ($wearhouses as $i => $wearhouse) { ?>
		document.getElementById('toggle-wearhouse-price-<?php echo $wearhouse->id; ?>').addEventListener('change', function() {
			var inputDiv = document.getElementById('wearhouse-price-input-<?php echo $wearhouse->id; ?>');
			var inputField = inputDiv.querySelector('input[name="wearhouse_unit_price_<?php echo $wearhouse->id; ?>"]');
			if (this.checked) {
				inputDiv.style.display = 'flex';
				inputField.disabled = false;
			} else {
