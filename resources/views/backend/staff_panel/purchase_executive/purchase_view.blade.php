                ...
                <div class="modal-body">
                    <div class="p-3">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="number" id="payment_amount" value="{{ array_sum($amount) }}" class="form-control textarea-autogrow mb-3" placeholder="{{ translate('Amount')}}" rows="1" name="amount" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
