                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="activity_table2">
                                ...
                                <tr id="row2_{{$key+1}}">
                                    <td>{{$key+1}}</td>
                                    <td>
                                        <input name="order_no[{{$key+1}}]" value="{{$activity->order_no}}" type="number" class="form-control gtorderid" placeholder="Enter Order ID" maxlength="10" required>
                                    </td>
                                    ...
                                    <td>
                                        <input name="credit[{{$key+1}}]" value="{{$activity->credit}}" type="number" class="form-control" placeholder="Enter Payment Amount">
                                    </td>
                                    <td>
                                    <select class="form-control" name="note[{{$key+1}}]">
                                        @foreach(App\Staff::where('role_id','15')->get() as $u)
                                    <option  @if($activity->note==$u->user_id) {{'selected'}} @endif value="{{$u->user_id}}">{{$u->user->name}}</option>
                                    @endforeach
                                        </select>
                                        <input name="note[{{$key+1}}]" value="{{$activity->note}}" type="text" class="form-control" placeholder="Enter Paid To"> 
                                    </td>
                                    <td>
                                        <input name="date[{{$key+1}}]" value="{{$activity->date}}" type="date" class="form-control" placeholder="Enter date">
                                    </td>
                                ...
                                <tr id="row2_1">
                                    <td>1</td>
                                    <td>
                                        <input name="order_no[1]" type="number"  class="form-control gtorderid" onblur="get_byorderid(1)" placeholder="Enter Order ID" maxlength="10" required>
                                    </td>
                                    ...
                                    <td>
                                        <input name="credit[1]" type="number" class="form-control" placeholder="Enter Payment Amount">
                                    </td>
                                    <td>
                                    <select class="form-control" name="note[1]">
                                        @foreach(App\Staff::where('role_id','15')->get() as $u)
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <input name="date[1]" type="date" class="form-control" placeholder="Enter date" value="{{$current_date}}">
                                    </td>
