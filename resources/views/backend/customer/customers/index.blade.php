            ...
            <form action="" method="get">
                <div class="row">
                    ...
                    <div class="col-md-2">
                            ...
                            <option <?php ?> value="Normal">Normal</option>
                            <option <?php ?> value="Premium">Premium</option>
                            <option <?php ?> value="Corporate">Corporate</option>
                            <option <?php ?> value="Employee">Employee</option>
                            <option <?php ?> value="Retail">Retail</option>
                            <option <?php ?> value="Website">Website</option>
                        </select>
                        </div>
