...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		<div class="col-md-6">
			<h1 class="h3">{{translate('All Invoice uploaded files')}}</h1>
		</div>
		<div class="col-md-6 text-md-right">
			<a href="{{ route('invoice-uploaded-files.create') }}" class="btn btn-primary">
				<span>{{translate('Upload New Invoice File')}}</span>
			</a>
		</div>
	</div>
</div>
