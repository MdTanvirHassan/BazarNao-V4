            ...
            <div class="col-md-2">
                <div class="form-group mb-0">
                    ...
                    <select class="form-control" name="order_from" id="order_from">
                        <option value="">Select One</option>
                        @foreach(\App\Models\Order::groupBy('order_from')->pluck('order_from') as $orderFrom)
                            <option value="{{ $orderFrom }}" @if($order_from == $orderFrom) selected @endif>{{ $orderFrom }}</option>
                        @endforeach
                    </select>
                </div>
        ...
        <table class="table table-sm table-hover table-bordered" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        {{ !empty($order->delivery_status) ? $order->delivery_status : 'undefined' }}
                    </td>
                    <td style="text-align:center;">
                        @if ($order->user != null)
