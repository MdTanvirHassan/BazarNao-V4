                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($product->delivered_date)
                                                ...
                                                @endphp
                                                <a href="{{ route('product_specific_day_sales_history_report.index', ['productId' => $product->productId, 'start_date' => $delivered_date, 'end_date' => $delivered_date, 'delivered_date' => $delivered_date]) }}" target="_blank">
                                                    {{ $product->getTranslation('product_name') }}
                                                </a>
                                            @else
                                                {{ $product->getTranslation('product_name') }}
