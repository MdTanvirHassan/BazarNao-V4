                            ...
                            <tr>
                                ...
                                <td>
                                    @if($product->delivered_date)
                                        @php
                                            $delivered_month = date("Y", strtotime($product->delivered_date));
                                            $start_date = date("Y-01-01", strtotime($product->delivered_date));
                                            $end_date = date("Y-12-t", strtotime($product->delivered_date));
                                        @endphp
                                        <a href="{{ route('product_history_report.index', ['productId' => $product->productId, 'start_date' => $start_date, 'end_date' => $end_date]) }}" target="_blank">
