                ...
                <div class="printArea">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ translate($saleType->customer_type) }}</td>
                                <td>{{ $saleType->warehouse_name }}</td>
                                <td>{{ $saleType->executive_name }}</td> 
                                <td class="text-right">{{$saleType->total_customer_type !==''? $saleType->total_customer_type : 'Undefine'}}</td>
                                <td class="text-right">{{$saleType->total_quantity}}</td>
