                    ...
                    <div class="form-group row">
                        <div class="col-md-3">
                            ...
                            <select id="demo-ease" class="aiz-selectpicker form-control select2" name="warehouse_id" data-live-search="true">
                                @foreach (\App\Models\Wearhouse::all() as $key => $row)
                        ...
                        <div class="col-md-4 mt-4">
                            ...
                            <button class="btn btn-success" type="submit" onclick="submitForm(this.value)" value="{{ route('export_monthly_stock_ledger_report') }}">{{ translate('Excel') }}</button>
                        </div>
