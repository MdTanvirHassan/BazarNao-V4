		...
		<form class="form form-horizontal mar-top" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group row">
	                    <label class="col-lg-3 col-from-label">{{translate('App unit price')}}</label>
	                    <div class="col-lg-6">
	                        <input type="number" lang="en" min="0" step="0.01" placeholder="{{translate('Unit price')}}" name="app_unit_price" class="form-control" value="{{$product->app_unit_price}}" required>
	                    </div>
	                </div>
					<div class="form-group row">
	                    <label class="col-lg-3 col-from-label">{{translate('Web unit price')}}</label>
	                    <div class="col-lg-6">
	                        <input type="number" lang="en" min="0" step="0.01" placeholder="{{translate('Unit price')}}" name="unit_price" class="form-control" value="{{$product->unit_price}}" required>
	                    </div>
	                </div>
					<?php
						...
						?>
							<div class="form-group row">
								<label class="col-md-3 col-form-label">
									{{ $product_stock->name }} Warehouse POS Price
								...
								<div class="col-md-6">
									<input type="number"
										...
										name="wearhouse_unit_price_<?php echo $product_stock->wearhouse_id; ?>"
