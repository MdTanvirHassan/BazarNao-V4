                    ...
                    <input type="hidden" name="quantity" value="1">
                                  <div class="card mb-2 shadow-sm">
                                      ...
                                      <div class="card-footer">
                                          ...
                                          @if ($wishlist->product->outofstock == 0)
                                        <button type="button"  id="addtocart_{{ $wishlist->product->id  }}" style="width:100%" class="btn btn-primary buy-now fw-600 add-to-cart" onclick="directAdd({{ $wishlist->product->id  }})">
