...
@section('content')
    ...
    <div class="home-banner-area mb-4">
        <div class="container-fluid">
            <div class="row gutters-10 position-relative">
                ...
                <div class="@if($num_todays_deal > 0) col-lg-10 @else col-lg-12 @endif"  style="padding-left:0px">
                ...
                @php
                    ...
                    @if ($sliders != null)
                        <div class="aiz-carousel dots-inside-bottom mobile-img-auto-height" data-arrows="true" data-dots="true" data-autoplay="true" data-infinite="true"> 
                            @php $slider_images = json_decode($sliders, true);  @endphp
                                ...
                                <div class="col mb-2">
                                    <a href="{{ route('product', $product->slug) }}" class="d-block p-2 text-reset bg-white h-100 rounded">
                                        <div class="row gutters-5 align-items-center">
                                            ...
                                            <div class="col-lg">
                                                <div class="fs-16">
                                                    <span class="d-block text-primary fw-600">{{ main_home_discounted_base_price($product->id) }}</span>
                                                    @if(main_home_base_price($product->id) != main_home_discounted_base_price($product->id))
                                                        <del class="d-block opacity-70">{{ main_home_base_price($product->id) }}</del>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="mb-4">
        <div class="container-fluid">
            <div class="row gutters-10">
                @php $banner_1_imags = json_decode($home_banner1_images); @endphp
                @foreach ($banner_1_imags as $key => $value)
                    <div class="col-xl col-md-6">
                        <div class="mb-3 mb-lg-0">
                            <a href="{{ json_decode($home_banner1_links, true)[$key] }}" class="d-block text-reset">
                    ...
                    <!-- <ul class="list-unstyled mb-0 row gutters-5"> -->
                        ...
                        <!-- <li class=""> -->
                            <div class="carousel-box">
                                ...
                                <button onclick="getSubCategory({{$category->id}})" class="dropdown-btn">
    ...
    <div class="mb-4">
        <div class="container-fluid">
            <div class="row gutters-10">
                @php $banner_2_imags = json_decode($home_banner2_images); @endphp
                @foreach ($banner_2_imags as $key => $value)
                    <div class="col-xl col-md-6">
                        <div class="mb-3 mb-lg-0">
                            <a href="{{ json_decode($home_banner2_links, true)[$key] }}" class="d-block text-reset">
    ...
    <img class="img-fluid" src="{{ static_asset('assets/img/whyshop.png') }}">
    </div>
    {{-- Best Selling  --}}
    ...
    <div class="mb-4">
        <div class="container-fluid">
            <div class="row gutters-10">
                @php $banner_3_imags = json_decode($home_banner3_images); @endphp
                @foreach ($banner_3_imags as $key => $value)
                    <div class="col-xl col-md-6">
                        <div class="mb-3 mb-lg-0">
                            <a href="{{ json_decode($home_banner3_links, true)[$key] }}" class="d-block text-reset">
...
@foreach($testimonials as $testimonial)
                    <div class="testimonial">
                        <div class="testimonial-content">
                            ...
                            @else
                            {{$testimonial->testimonial_bangla}}
                            @endif
                            </p>
                            <hr>
                ...
                @if ($testimonial->avatar_original != null)
                    <img src="{{ uploaded_asset($testimonial->avatar_original) }}" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';">
                @else
                ...
                @endif
                                ...
                                <div class="col-md-12">
                        <span class="post">{{$testimonial->name}}</span>
                                </div>
                            </div>
                        </div>
