    ...
    $('.pro_list_block').removeAttr("style"); 
      ...
      $('#searchm').on('keyup', function(){
        ...
        function updateNavCart(){
            ...
            $.post('{{ route('cart.updateRightCart') }}', {_token: AIZ.data.csrf }, function(data){
...
function updateQuantityP(key, element,id){
        ...
        $.post('{{ route('cart.updateQuantity') }}', { _token:'{{ csrf_token() }}', key:key, quantity: (element+1)}, function(data){
			if(data==0){
