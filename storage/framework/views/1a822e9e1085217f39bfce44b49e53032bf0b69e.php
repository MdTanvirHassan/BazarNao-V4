<div style="width:100%;left:0px;" class="aiz-topbar px-15px px-lg-25px d-flex align-items-stretch justify-content-between">
    ...
    <div class="d-flex justify-content-between align-items-stretch flex-grow-xl-1">
        ...
        <div class="d-none d-md-flex justify-content-around align-items-center align-items-stretch">
            ...
            $logo = get_setting('header_logo');
            ?>
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="d-block" style="padding-right:20px;margin-right:10px; border-right:1px solid grey">
                <?php if($logo != null): ?>
                <img src="<?php echo e(uploaded_asset($logo)); ?>" class="brand-icon" alt="<?php echo e(get_setting('website_name')); ?>">
                <?php else: ?>
                <img src="<?php echo e(static_asset('assets/img/logo.png')); ?>" class="brand-icon" alt="<?php echo e(get_setting('website_name')); ?>">
                    ...
                    <a class="dropdown-toggle no-arrow text-dark" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="d-none d-md-block">
                                ...
                                <span class="d-block small opacity-60"><?php echo e(Auth::user()->user_type); ?> 
...
</div><!-- .aiz-topbar --><?php /**PATH C:\xampp82\htdocs\bazarnao-v4-laravel-9\resources\views/backend/inc/staff_nav.blade.php ENDPATH**/ ?>