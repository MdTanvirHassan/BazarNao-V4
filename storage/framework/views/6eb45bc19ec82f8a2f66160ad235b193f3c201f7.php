        ...
        <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
            <div class="d-flex mb-3 align-items-baseline border-bottom">
                <h3 class="h5 fw-700 mb-0">
                    <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block"><?php echo e(translate('Group Products')); ?></span>
                </h3>
            </div>
...
</section><?php /**PATH C:\xampp82\htdocs\bazarnao-v4-laravel-9\resources\views/frontend/partials/group_product_section.blade.php ENDPATH**/ ?>