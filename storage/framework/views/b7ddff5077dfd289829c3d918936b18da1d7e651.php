    ...
    AIZ.plugins.chart('#pie-2',{
        ...
        data: {
            ...
            datasets: [
                {
                    data: [
                        <?php echo e(\App\Models\Seller::all()->count()); ?>,
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8.2.12\htdocs\bazarnao-v4-laravel-9\resources\views/backend/dashboard.blade.php ENDPATH**/ ?>