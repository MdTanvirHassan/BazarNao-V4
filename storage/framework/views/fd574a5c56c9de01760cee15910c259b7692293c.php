        ...
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-md-auto">
                    <a href="<?php echo e(route('products.create')); ?>" class="btn btn-sm btn-rectangle btn-info">
                        <span><?php echo e(translate('Add New Product')); ?></span>
                    </a>
                </div>
                <div class="col-md-auto">
                    <a href="<?php echo e(route('group_products.create')); ?>" class="btn btn-sm btn-rectangle btn-info">
                        <span><?php echo e(translate('Add New Group Product')); ?></span>
                    </a>
                </div>
            </div>
        </div>
	...
	<form class="" id="sort_products" action="" method="GET">
		<div class="card-header row gutters-5">
            ...
            <select class="form-control form-control-sm aiz-selectpicker mb-2 mb-md-0" name="type" id="type" onchange="sort_products()">
                    ...
                    <option value="name,asc"<?php if(isset($col_name , $query)): ?> <?php if($col_name == 'name' && $query == 'asc'): ?> selected <?php endif; ?> <?php endif; ?>><?php echo e(translate('A to Z (Order By Ascending)')); ?></option>
			        <option value="name,desc"<?php if(isset($col_name , $query)): ?> <?php if($col_name == 'name' && $query == 'desc'): ?> selected <?php endif; ?> <?php endif; ?>><?php echo e(translate('Z to A (Order By Descending)')); ?></option>
                    <option value="last,added"<?php if(isset($col_name , $query)): ?> <?php if($col_name == 'name' && $query == 'desc'): ?> selected <?php endif; ?> <?php endif; ?>><?php echo e(translate('Last Added Products')); ?></option>
        ...
        <table class="table aiz-table mb-0">
            <thead>
                <tr>
                    ...
                    <?php endif; ?>
                    <th><?php echo e(translate('Barcode')); ?></th>
                    <th><?php echo e(translate('Num of Sale')); ?></th>
                    <th><?php echo e(translate('Total Stock')); ?></th>
                    <th><?php echo e(translate('App Price')); ?></th>
                    <th><?php echo e(translate('Web Price')); ?></th>
                    <th><?php echo e(translate('Pos Price')); ?></th>
                    ...
                    <th><?php echo e(translate('Refundable')); ?></th>
                    <th><?php echo e(translate('OutofStock')); ?></th>
            ...
            <tbody>
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <?php if($type == 'Seller' || $type == 'All'): ?>
                            <?php if(isset($product->user->name)): ?>
                        ...
                        <td><?php echo e(number_format($product->app_unit_price,2)); ?></td>
                        ...
                        <td>
                        <label class="aiz-switch aiz-switch-success mb-0">
	                            <input onchange="update_refundable(this)" value="<?php echo e($product->id); ?>" type="checkbox" <?php if($product->refundable == 1) echo "checked";?> >
	                            <span class="slider round"></span>
							</label>
						</td>
                        <td>
                        <label class="aiz-switch aiz-switch-success mb-0">
	                            <input onchange="update_outofstock(this)" value="<?php echo e($product->id); ?>" type="checkbox" <?php if($product->outofstock == 1) echo "checked";?> >
	                            <span class="slider round"></span>
							</label>
						</td>
						<td class="text-right">
							...
							<?php else: ?>
                                <?php if($product->is_group_product): ?>
								<a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="<?php echo e(route('group_products.admin.edit', ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE')] )); ?>" title="<?php echo e(translate('Group Product Edit')); ?>">
								   <i class="las la-edit"></i>
							   </a>
                               <?php else: ?>
                           ...
                           <?php if(auth()->user()->user_type == 'admin'): ?>
                                <?php if($product->is_group_product): ?>
                                <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="<?php echo e(route('group_products.destroy', $product->id)); ?>" title="<?php echo e(translate('Group Product Delete')); ?>">
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        function update_refundable(el){
            ...
            $.post('<?php echo e(route('products.refundable')); ?>', {_token:'<?php echo e(csrf_token()); ?>', id:el.value, status:status}, function(data){
                if(data == 1){
                    AIZ.plugins.notify('success', '<?php echo e(translate('Refundable updated successfully')); ?>');
                }
                else{
                    AIZ.plugins.notify('danger', '<?php echo e(translate('Something went wrong')); ?>');
                }
        ...
        function update_outofstock(el){
            ...
            $.post('<?php echo e(route('products.outofstock')); ?>', {_token:'<?php echo e(csrf_token()); ?>', id:el.value, status:status}, function(data){
                if(data == 1){
                    AIZ.plugins.notify('success', '<?php echo e(translate('Out Of Stock updated successfully')); ?>');
                }
                else{
                    AIZ.plugins.notify('danger', '<?php echo e(translate('Something went wrong')); ?>');
                }
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp82\htdocs\bazarnao-v4-laravel-9\resources\views/backend/product/products/index.blade.php ENDPATH**/ ?>