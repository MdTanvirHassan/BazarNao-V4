        ...
        <table class="table aiz-table mb-0">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(translate('Category Wise Product')); ?></th>
            ...
            <tbody>
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="checkbox" onchange="update_featured_category_wise(this)" value="<?php echo e($category->id); ?>" <?php if($category->category_wise == 1) echo "checked";?>>
                                <span></span>
                            </label>
                        </td>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        function update_featured_category_wise(el){
            ...
            $.post('<?php echo e(route('categories.featured_category_wise')); ?>', {_token:'<?php echo e(csrf_token()); ?>', id:el.value, status:status}, function(data){
                if(data == 1){
                    AIZ.plugins.notify('success', '<?php echo e(translate('Category Wise Product updated successfully')); ?>');
                }
                else{
                    AIZ.plugins.notify('danger', '<?php echo e(translate('Something went wrong')); ?>');
                }
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp82\htdocs\bazarnao-v4-laravel-9\resources\views/backend/product/categories/index.blade.php ENDPATH**/ ?>