  ...
  <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
                ...
                <div class="col-auto col-xl-2 pl-0 pr-3 d-flex align-items-center">
                    <a class="" href="<?php echo e(route('home')); ?>" style="padding:10px;">
                        ...
                        <img src="<?php echo e(uploaded_asset($header_logo)); ?>" alt="<?php echo e(env('APP_NAME')); ?>" class="mw-100 h-30px h-md-<?php echo e($header_height); ?>px" height="<?php echo e($header_height); ?>">
                        <?php else: ?>
...
<i style="font-size: 35px;font-weight: bold;color:#AF3C87;" class="las la-list-ul la-2x d-inline-block nav-box-icon"></i>
    ...
    <?php endif; ?>
</header><?php /**PATH D:\xampp8.2.12\htdocs\bazarnao-v4-laravel-9\resources\views/frontend/inc/nav.blade.php ENDPATH**/ ?>