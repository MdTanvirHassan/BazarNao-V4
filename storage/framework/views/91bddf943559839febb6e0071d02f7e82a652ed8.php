                ...
                <div class="row aiz-steps arrow-divider">
                    ...
                    <div class="col">
                        <div class="text-center">
                            ...
                            <h3 class="fs-14 fw-600 d-none d-lg-block opacity-50 text-capitalize"><?php echo e(translate('2. Shipping & Payment')); ?></h3>
                        </div>
                    </div>
                    <div class="col">
                        <div class="text-center">
                                            ...
                                            <div class="col-lg col-6 order-4 order-lg-0">
                                                <?php if($cartItem['digital'] != 1): ?>
                                                    <div class="row no-gutters align-items-center aiz-plus-minus mr-2 ml-0">
                                                        ...
                                                        <input type="text" name="quantity[<?php echo e($key); ?>]" class="col border-0 text-center flex-grow-1 fs-16 input-number" placeholder="1" value="<?php echo e($cartItem['quantity']); ?>" min="1" max="1000" readonly onchange="updateQuantity(<?php echo e($key); ?>, this)">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\bazarnao-v4-laravel-9\resources\views/frontend/view_cart.blade.php ENDPATH**/ ?>