...
<div class="card">
    <form id="culexpo" action="<?php echo e(route('transfer_list_report.index')); ?>" method="GET">
        <div class="card-header row gutters-5">
            ...
            <div class="col-auto">
                <div class="form-group mb-0 mt-2">
                    <button class="btn btn-sm btn-primary" onclick="submitForm('<?php echo e(route('transfer_list_report.index')); ?>')"><?php echo e(translate('Filter')); ?></button>
    ...
    <div class="card-body">
        ...
        <h3 style="text-align:center;"><?php echo e(translate('Transfer List Report')); ?></h3>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp82\htdocs\bazarnao-v4-laravel-9\resources\views/backend/reports/transfer_list.blade.php ENDPATH**/ ?>