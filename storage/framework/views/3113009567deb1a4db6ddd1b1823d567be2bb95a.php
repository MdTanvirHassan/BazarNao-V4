...
<div class="aiz-category-menu bg-white rounded <?php if(Route::currentRouteName() == 'home'): ?> shadow-sm" <?php else: ?> shadow-lg" id="category-sidebar" <?php endif; ?>>
     ...
     <?php  echo file_get_contents(base_path('category_menu_static.php'), true); ?>
</div>
<script>
...
</script><?php /**PATH D:\xampp8.2.12\htdocs\bazarnao-v4-laravel-9\resources\views/frontend/partials/category_menu.blade.php ENDPATH**/ ?>