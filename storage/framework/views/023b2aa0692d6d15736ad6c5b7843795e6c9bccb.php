                                        ...
                                        <?php if(count($order->orderDetails) > 0): ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if($order->orderDetails->first()->delivery_status == 'delivered' && $order->payment_status == 'paid'): ?>
                                                        <a id="received_<?php echo e($order->id); ?>" href="javascript:void(0)" class="btn btn-soft-primary btn-icon btn-circle btn-sm" onclick="orderReceived(<?php echo e($order->id); ?>)" title="<?php echo e(translate('Order Received')); ?>">
                                                    ...
                                                    <?php if($order->payment_status != 'paid'): ?>
                                                        <a id="payment_<?php echo e($order->id); ?>" target='_blank' href="<?php echo e(route('order_payment.show', $order->id)); ?>" class="btn btn-soft-primary btn-icon btn-circle btn-sm"  title="Payment">
                                                           <i class="las la-check"></i>
                                                       </a>
                                                    <?php endif; ?>
    ...
    <script type="text/javascript">
        ...
        function orderReceived(order_id){
            ...
            $.post('<?php echo e(route('orders.update_delivery_status')); ?>', {_token:'<?php echo e(@csrf_token()); ?>',order_id:order_id,status:status}, function(data){
                ...
                AIZ.plugins.notify('success', '<?php echo e(translate('Order Received Successfully')); ?>');
            });
        }
        }
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp82\htdocs\bazarnao-v4-laravel-9\resources\views/frontend/user/purchase_history.blade.php ENDPATH**/ ?>