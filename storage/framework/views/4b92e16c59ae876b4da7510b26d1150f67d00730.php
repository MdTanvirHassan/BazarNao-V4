                            ...
                            <div class="row">
                                <div class="col-xxl-8 col-xl-10 mx-auto">
                                    <div class="row gutters-10">
                                        ...
                                        <?php endif; ?>
                                        <?php if(\App\Models\BusinessSetting::where('type', 'instamojo_payment')->first()->value == 1): ?>
                                        <div class="col-6 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                        ...
                                        <?php endif; ?>
                                        <?php if(\App\Models\BusinessSetting::where('type', 'razorpay')->first()->value == 1): ?>
                                        <div class="col-6 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                        ...
                                        <?php endif; ?>
                                        <?php if(\App\Models\BusinessSetting::where('type', 'paystack')->first()->value == 1): ?>
                                        <div class="col-6 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                        ...
                                        <?php endif; ?>
                                        <?php if(\App\Models\BusinessSetting::where('type', 'voguepay')->first()->value == 1): ?>
                                        <div class="col-6 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                        ...
                                        <?php endif; ?>
                                        <?php if(\App\Models\BusinessSetting::where('type', 'payhere')->first()->value == 1): ?>
                                        <div class="col-6 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                        ...
                                        <?php endif; ?>
                                        <?php if(\App\Models\BusinessSetting::where('type', 'ngenius')->first()->value == 1): ?>
                                        <div class="col-6 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                        ...
                                        <?php endif; ?>
                                        <?php if(\App\Models\BusinessSetting::where('type', 'iyzico')->first()->value == 1): ?>
                                        <div class="col-6 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\bazarnao-v4-laravel-9\resources\views/frontend/payment_select.blade.php ENDPATH**/ ?>