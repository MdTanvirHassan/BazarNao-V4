            ...
            <?php if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions))): ?>
             ...
             <?php endif; ?>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <!-- <?php if(Auth::user()->user_type == 'admin' || in_array('27', json_decode(Auth::user()->staff->role->permissions))): ?>
                        <li class="aiz-side-nav-item">
                            <a href="<?php echo e(route('wearhouse_wise_stock_ledger_report.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['wearhouse_wise_stock_ledger_report.index'])); ?>">
                                <span class="aiz-side-nav-text"><?php echo e(translate('Product wise stock ledger report')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?> -->
            ...
            <?php endif; ?>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="<?php echo e(route('bank.index')); ?>" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text"><?php echo e(translate('Bank')); ?></span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
...
</div><!-- .aiz-sidebar --><?php /**PATH D:\xampp8.2.12\htdocs\bazarnao-v4-laravel-9\resources\views/backend/inc/admin_sidenav.blade.php ENDPATH**/ ?>