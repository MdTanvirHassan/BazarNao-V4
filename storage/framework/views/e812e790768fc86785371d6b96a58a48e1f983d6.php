    ...
    <?php if(Session::has('cart')): ?>
        <?php if(count($cart = Session::get('cart')) > 0): ?>
                ...
                <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($product != null): ?>
                        <li class="list-group-item">
                            ...
                            <div style="width: 10%;">
                            <button onclick="updateQuantityP(<?php echo e($key); ?>, <?php echo e($cartItem['quantity']); ?>,<?php echo e($cartItem['id']); ?>)" class="btn btn-sm btn-icon " style="padding-left: 0px;">
                                        <i class="la la-angle-up"></i>
                                    </button><br/>
                                    <span id="rightqty_<?php echo e($cartItem['id']); ?>" style="padding-left: 8px;"><?php echo e($cartItem['quantity']); ?></span><br/>
                                    <button onclick="updateQuantityM(<?php echo e($key); ?>, <?php echo e($cartItem['quantity']); ?>,<?php echo e($cartItem['id']); ?>)"  <?php if($cartItem['quantity'] == 1) echo 'disabled ' ?> onclick="minuscartqty(<?php echo e($key); ?>)" class="btn btn-sm btn-icon" style="padding-left: 0px;">
            ...
            <div class="px-3 py-2 fs-15 border-top d-flex justify-content-between">
                <span class="opacity-60"><?php echo e(translate('Offer Discount')); ?></span>
                <span class="fw-600"><?php echo e(single_price(Session::get('offer_discount'))); ?></span>
            </div>
            <?php endif; ?>
            <div class="px-3 py-2 fs-15 border-top d-flex justify-content-between">
...
<?php /**PATH D:\xampp8.2.12\htdocs\bazarnao-v4-laravel-9\resources\views/frontend/inc/rightsidebar.blade.php ENDPATH**/ ?>