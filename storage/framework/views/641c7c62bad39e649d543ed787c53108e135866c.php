    ...
    <div class="aiz-user-sidenav rounded overflow-hidden  c-scrollbar-light">
        <div class="px-4 text-center mb-4">
            ...
            <?php if(Auth::user()->user_type == 'customer'): ?>
                ...
                <h4 class="h5 fw-600">ID : <?php echo e(Auth::user()->customer->customer_id); ?></h4>
        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <?php endif; ?>
				<li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('referral_link.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['referral_link.index'])); ?>">
                        <i class="la la-heart-o aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text"><?php echo e(translate('Referral Link')); ?></span>
                    </a>
                </li>
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('coupon_usage.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['coupon_usage.index'])); ?>">
                        <i class="la la-heart-o aiz-side-nav-icon"></i>
                ...
                <?php if(Auth::user()->user_type == 'seller'): ?>
                    <?php if(App\Models\Addon::where('unique_identifier', 'pos_system')->first() != null && App\Models\Addon::where('unique_identifier', 'pos_system')->first()->activated): ?>
                        <?php if(App\Models\BusinessSetting::where('type', 'pos_activation_for_seller')->first() != null && App\Models\BusinessSetting::where('type', 'pos_activation_for_seller')->first()->value != 0): ?>
                            <li class="aiz-side-nav-item">
                ...
                <?php if(App\Models\BusinessSetting::where('type', 'conversation_system')->first()->value == 1): ?>
                    <?php
                ...
                <?php if(App\Models\BusinessSetting::where('type', 'wallet_system')->first()->value == 1): ?>
                    <li class="aiz-side-nav-item">
                ...
                <?php if(App\Models\Addon::where('unique_identifier', 'affiliate_system')->first() != null && App\Models\Addon::where('unique_identifier', 'affiliate_system')->first()->activated && Auth::user()->affiliate_user != null && Auth::user()->affiliate_user->status): ?>
                    <li class="aiz-side-nav-item">
        ...
        <?php if(App\Models\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1 && Auth::user()->user_type == 'customer'): ?>
            <div>
...
<?php /**PATH C:\xampp82\htdocs\bazarnao-v4-laravel-9\resources\views/frontend/inc/user_side_nav.blade.php ENDPATH**/ ?>