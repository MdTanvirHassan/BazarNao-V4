...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/customers_comments_complain', [HomeController::class, 'customers_comments_complain'])->name('customers_comments_complain');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::post('/banks/update/{id}', [BankController::class, 'update'])->name('bank.update');
...
Route::post('/get_puracher_product', [OrderController::class, 'get_puracher_product'])->name('purchase_orders.get_puracher_product');
    ...
    Route::get('/product_wise_purchase_export', [DownloadReportController::class, 'product_wise_purchase_export'])->name('product_wise_purchase_export');
    ...
    Route::any('/PlatformSalesReport', [ReportController::class, 'PlatformSalesReport'])->name('PlatformSalesReport.index');
    Route::any('/transfer_list_report', [ReportController::class, 'transfer_list_report'])->name('transfer_list_report.index');
...
Route::resource('damage', DamageController::class)->except(['create', 'show', 'store']);
...
Route::get('/product_wise_purchase_report', [ReportController::class, 'product_wise_purchase_report'])->name('product_wise_purchase_report.index');
